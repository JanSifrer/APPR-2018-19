...
```{r graf 1, echo=FALSE, fig.align='center', fig.cap='Graf 1: Države selitev'}
...
```
Kot sem že omenil, je Slovenija glede preseljevanja na samem vrhu. In kar ponuja se logično vprašanje: Ali je to v redu, ali ne?
...
```{r graf 2, echo=FALSE, fig.align='center', fig.cap='graf 2: Izseljeni po starosti'}
...
```{r graf 3, echo=FALSE, fig.align='center',  fig.cap='Graf 3: Izseljeni po izobrazbi'}
...
```{r graf 4, echo=FALSE, fig.align='center', fig.cap='Graf 4: Priseljeni po letih'}
...
```{r graf 5, echo=FALSE, fig.align='center', fig.cap='Graf 5: Priseljeni po izobrazbi'}
ggplot(data=meddrzavne.selitve.osnovni %>% 
...
```{r graf 6, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Graf 6: Število priseljencev v obdobju 1991-2017"}
...
Tema mi je bila zelo zanimiva. Osebno sem izvedel veliko novega o preseljevanju Slovencev. Najbolj pa me je presenetilo prav dejstvo, katerega prikazuje Graf 1, in sicer da je Slovenija tako visoko na lestvici glede selitev.